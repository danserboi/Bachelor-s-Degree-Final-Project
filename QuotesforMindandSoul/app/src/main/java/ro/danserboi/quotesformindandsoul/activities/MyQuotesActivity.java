...
public class MyQuotesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.my_quotes_recyclerview);
        // Set the GridLayoutManager.
        mRecyclerView.setLayoutManager(new LinearLayoutManager(MyQuotesActivity.this));

        // Initialize the ArrayList that will contain the data.
        mQuotesData = new ArrayList<>();

        // Initialize the adapter and set it to the RecyclerView.
        mAdapter = new QuoteAdapter(MyQuotesActivity.this, mQuotesData);
    ...
    private void getData() {
        ...
        Call<QuotesList> call = api.getMyQuotes("Bearer " + userPrefs.getJWT());
